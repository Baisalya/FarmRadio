...
import com.example.farmradio.adapters.GalleryAdapter
...
class GalleryFragment : Fragment() {
    ...
    private lateinit var galleryAdapter: GalleryAdapter // Create a RecyclerView adapter
    ...
    private fun loadVideoItems() {
        ...
        reference.listAll()
            .addOnSuccessListener { result ->
                val videoItems = mutableListOf<ImageItem>()
                ...
                Tasks.whenAllComplete(downloadTasks)
                    .addOnSuccessListener {
                        ...
                        galleryAdapter.submitList(videoItems)
